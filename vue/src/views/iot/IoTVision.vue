  ...
  <div class="iot-vision">
    <section class="vision-hero">
      ...
      <div class="hero-actions">
        <el-select v-model="detectMode" size="small" class="hero-select">
          <el-option label="病害辅助识别" value="disease"></el-option>
          <el-option label="双检分析" value="both"></el-option>
        </el-select>
        <el-select v-model="cropType" size="small" class="hero-select">
    ...
    <section class="vision-layout">
      <article class="panel preview-panel">
        ...
        <div class="preview-stage">
          <div v-if="mode === 'stream'" class="stream-box">
            <div class="stream-toolbar">
              ...
              <el-button size="small" type="primary" @click="saveCameraUrl">保存地址</el-button>
            </div>
            ...
            <div class="stream-actions">
              <el-button size="small" type="primary" @click="startStream">启动实时流</el-button>
              <el-button size="small" @click="captureFrame">截图分析</el-button>
            </div>
          </div>
        ...
        <div class="analyze-bar">
          <el-select v-model="selectedFarmId" size="small" placeholder="选择关联地块">
            <el-option
              v-for="farm in farms"
              :key="farm.id"
              :label="farm.farm"
          ...
          <el-button type="primary" size="small" :loading="loading" @click="analyzeCurrentFrame">
            开始识别
          </el-button>
        </div>
      </article>
      ...
      <article class="panel result-panel">
        ...
        <div class="result-actions">
          <el-button type="primary" size="small" :disabled="!canCreateAlert" @click="pushToAlertCenter">
            写入预警中心
          </el-button>
          <el-button size="small" @click="$router.push('/iot-alert-center')">查看闭环</el-button>
        </div>

        <div class="detection-list">
          <h3>原始检测明细</h3>
          <template v-if="analysisDetections.length">
            <div class="detection-item" v-for="(item, index) in analysisDetections" :key="index">
