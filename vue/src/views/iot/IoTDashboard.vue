  ...
  <div class="iot-dashboard">
    <section class="hero-panel">
      ...
      <div class="hero-actions">
        ...
        <el-button type="primary" icon="el-icon-refresh" size="small" @click="refreshAll">
          刷新数据
        </el-button>
      </div>
    </section>
    ...
    <section class="content-grid">
      ...
      <article class="panel card-alerts">
        <div class="panel-head">
          ...
          <el-button link @click="$router.push('/iot-alert-center')">查看全部</el-button>
        </div>
      ...
      <article class="panel card-vision">
        ...
        <div class="vision-body">
          ...
          <div class="vision-copy">
            ...
            <el-button type="primary" size="small" @click="$router.push('/iot-vision')">
              进入巡检页
            </el-button>
          </div>
        </div>
