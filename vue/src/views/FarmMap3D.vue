    ...
    async fetchSTM32Data() {
      ...
      try {
        ...
        if (res1.code === '200' && res1.data) {
          ...
          console.log('✅ 设备1(STM32-001)数据:', this.stm32Data.device1);
        }
      } catch (e) {
        console.warn('⚠️ 设备1数据获取失败', e);
      ...
      try {
        ...
        if (res2.code === '200' && res2.data) {
          ...
          console.log('✅ 设备2(STM32-PUMP)数据:', this.stm32Data.device2);
        }
      } catch (e) {
        console.warn('⚠️ 设备2数据获取失败', e);
