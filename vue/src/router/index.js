  ...
  if (storeMenus) {
    const manageRoute = { 
      ...
      children: [
        ...
        { path: 'home', name: '总控驾驶舱', component: () => import('../views/Home.vue')},
        { path: 'aether-monitor', name: '物联感知与联动', component: () => import('../views/AetherMonitor.vue')},
        { path: 'dashbordnew', name: '农情监测推演', component: () => import('../views/DashbordNew.vue')},
        { path: 'bigscreen', name: '全局态势大屏', component: () => import('../views/BigScreen.vue')},
        { path: 'farmmap3d', name: '农场 3D 孪生', component: () => import('../views/FarmMap3D.vue')},
        { path: 'farm-map-gaode', name: 'GIS 指挥地图', component: () => import('../views/FarmMapGaode.vue')},
        { path: 'statistic', name: '农情数据总览', component: () => import('../views/Statistic.vue')},
        { path: 'business-analysis', name: '决策预警中心', component: () => import('../views/BusinessAnalysis.vue')},
        ...
        { path: 'fruit-detect', name: '作物智能诊断', component: () => import('../views/FruitDetect.vue')},
      ] 
    }
